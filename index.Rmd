...
I chose this chart because it's great. It reveals a lot of things.

The scatter plot below represents how a movie's production budget determines its success in theaters. 
As seen below, the correlation between the two features proves inconclusive.
There are great clusters at $500,000; $1,000,000; and $1,500,000 as many producers round their expenses to the simplest value;
as a result, the data is severely limited and does not accurately represent exactly how budget relates to success.
...
(I would have ideally made a box and whiskers plot to properly analyze the data, but I lacked the knowledge to do so.)
